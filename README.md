...
[View the static poster](docs/media/responsive-scroll-walkthrough-poster.png) · [Download the H.264 walkthrough](docs/media/responsive-scroll-walkthrough.mp4)
...
[Play the GIF](docs/media/programme-walkthrough.gif) · [Download the MP4](docs/media/programme-walkthrough.mp4) · [Follow the programme data](docs/case-study/04-the-ground-event-interface.md)
...
[Play the GIF](docs/media/venue-guide-walkthrough.gif) · [Download the MP4](docs/media/venue-guide-walkthrough.mp4) · [Read the visitor-journey notes](docs/case-study/03-visitor-journey.md)
...
[Play the GIF](docs/media/brand-discovery-walkthrough.gif) · [Download the MP4](docs/media/brand-discovery-walkthrough.mp4) · [Read how the Guidebook became web content](docs/case-study/02-guidebook-and-agent-workflow.md)
...
[Play the GIF](docs/media/guidebook-journey-walkthrough.gif) · [Download the MP4](docs/media/guidebook-journey-walkthrough.mp4) · [See every Guidebook entry path](docs/diagrams/guidebook-entry-and-reading-flow.svg) · [Read the content workflow](docs/case-study/02-guidebook-and-agent-workflow.md)
